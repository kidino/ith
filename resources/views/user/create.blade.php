{{-- filepath: c:\laragon\www\ith\resources\views\user\create.blade.php --}}
<x-app-layout>
    <x-slot name="header">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <form method="POST" action="{{ route('users.store') }}" id="user-form">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" class="w-full rounded border-gray-300" required value="{{ old('email') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="user_type" id="user_type" class="w-full rounded border-gray-300" required>
                            ...
                            <option value="it" @if(old('user_type')=='it') selected @endif>IT</option>
                            <option value="user" @if(old('user_type')=='user') selected @endif>User</option>
                            <option value="vendor" @if(old('user_type')=='vendor') selected @endif>Vendor</option>
                        </select>
